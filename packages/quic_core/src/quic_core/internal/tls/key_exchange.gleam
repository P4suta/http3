...
@external(erlang, "quic_core_crypto_ffi", "x25519_generate")
fn raw_generate_x25519() -> Result(#(BitArray, BitArray), Int)

@external(erlang, "quic_core_crypto_ffi", "x25519_public")
fn raw_x25519_public(private_key: BitArray) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "x25519_shared")
fn raw_x25519_shared(
  private_key: BitArray,
  peer_public_key: BitArray,
) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "p256_generate")
fn raw_generate_p256() -> Result(#(BitArray, BitArray), Int)

@external(erlang, "quic_core_crypto_ffi", "p256_public")
fn raw_p256_public(private_key: BitArray) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "p256_shared")
fn raw_p256_shared(
  private_key: BitArray,
  peer_public_key: BitArray,
) -> Result(BitArray, Int)
