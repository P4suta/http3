...
@external(erlang, "quic_core_crypto_ffi", "hmac_sha256")
fn raw_hmac_sha256(key: BitArray, data: BitArray) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "hmac_sha384")
fn raw_hmac_sha384(key: BitArray, data: BitArray) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "hash_sha256")
fn raw_hash_sha256(data: BitArray) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "hash_sha384")
fn raw_hash_sha384(data: BitArray) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "secure_random")
fn raw_secure_random(length: Int) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "aes_128_ecb_encrypt")
fn raw_aes_128_ecb_encrypt(
  key: BitArray,
  block: BitArray,
) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "aes_256_ecb_encrypt")
fn raw_aes_256_ecb_encrypt(
  key: BitArray,
  block: BitArray,
) -> Result(BitArray, Int)

@external(erlang, "quic_core_crypto_ffi", "aes_128_gcm_encrypt")
...
@external(erlang, "quic_core_crypto_ffi", "aes_128_gcm_decrypt")
...
@external(erlang, "quic_core_crypto_ffi", "aes_256_gcm_encrypt")
...
@external(erlang, "quic_core_crypto_ffi", "aes_256_gcm_decrypt")
...
@external(erlang, "quic_core_crypto_ffi", "chacha20_poly1305_encrypt")
...
@external(erlang, "quic_core_crypto_ffi", "chacha20_poly1305_decrypt")
...
@external(erlang, "quic_core_crypto_ffi", "chacha20_header_mask")
