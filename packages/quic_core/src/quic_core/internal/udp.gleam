...
@external(erlang, "quic_core_udp_ffi", "open")
fn raw_open(address: BitArray, port: Int) -> Result(Socket, Int)

@external(erlang, "quic_core_udp_ffi", "open_dual_stack")
fn raw_open_dual_stack(port: Int) -> Result(Socket, Int)

@external(erlang, "quic_core_udp_ffi", "local_endpoint")
fn raw_local_endpoint(socket: Socket) -> Result(#(BitArray, Int), Int)

@external(erlang, "quic_core_udp_ffi", "resolve")
fn raw_resolve(host: String, family: Int) -> Result(List(BitArray), Int)

@external(erlang, "quic_core_udp_ffi", "resolve_timeout")
...
@external(erlang, "quic_core_udp_ffi", "send")
fn raw_send(
  socket: Socket,
  address: BitArray,
  port: Int,
...
@external(erlang, "quic_core_udp_ffi", "recv")
fn raw_receive(
  socket: Socket,
  timeout_milliseconds: Int,
) -> Result(#(BitArray, Int, BitArray, Int), Int)

@external(erlang, "quic_core_udp_ffi", "active_once")
fn raw_activate_once(socket: Socket) -> Result(Nil, Int)

@external(erlang, "quic_core_udp_ffi", "active_datagram")
fn raw_active_datagram(
  socket: Socket,
  message: Dynamic,
) -> Result(#(BitArray, Int, BitArray, Int), Int)

@external(erlang, "quic_core_udp_ffi", "start_relay")
fn raw_start_relay(socket: Socket) -> Result(Relay, Int)

@external(erlang, "quic_core_udp_ffi", "relay_batch")
fn raw_relay_batch(
  relay: Relay,
  message: Dynamic,
) -> Result(List(#(BitArray, Int, BitArray, Int)), Int)

@external(erlang, "quic_core_udp_ffi", "continue_relay")
fn raw_continue_relay(relay: Relay) -> Result(Nil, Int)

@external(erlang, "quic_core_udp_ffi", "stop_relay")
fn raw_stop_relay(relay: Relay) -> Result(Nil, Int)

@external(erlang, "quic_core_udp_ffi", "supports_ecn")
fn raw_supports_ecn(socket: Socket) -> Bool

@external(erlang, "quic_core_udp_ffi", "dont_fragment_active")
fn raw_dont_fragment(socket: Socket) -> Bool

@external(erlang, "quic_core_udp_ffi", "close")
fn raw_close(socket: Socket) -> Result(Nil, Int)

@external(erlang, "quic_core_udp_ffi", "transfer_owner")
fn raw_transfer_owner(socket: Socket, owner: Pid) -> Result(Nil, Int)

@external(erlang, "quic_core_udp_ffi", "monotonic_millisecond")
fn raw_monotonic_millisecond() -> Int

@external(erlang, "quic_core_udp_ffi", "unix_millisecond")
...
/// Send one UDP datagram without applying an ECN marking.
pub fn send_unmarked(
  socket: Socket,
  peer: Endpoint,
  payload: BitArray,
) -> Result(Nil, Error) {
  send(socket, peer, payload, ecn.NotEct)
}
