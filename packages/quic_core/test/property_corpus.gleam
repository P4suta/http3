...
import quic_core/frame as transport_frame
import quic_core/varint

const generator_modulus = 2_147_483_647

/// Check generated varint and transport-frame round trips.
pub fn exercise(cases: Int) -> Int {
  exercise_from(982_451_653, cases)
}

// nolint: unused_exports -- the campaign escript invokes this compiled entry.
/// Check a deterministic shard beginning from an explicitly retained seed.
pub fn exercise_from(seed: Int, cases: Int) -> Int {
  exercise_cases(seed, cases)
  cases
}
