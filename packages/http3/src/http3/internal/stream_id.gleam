...
//// that root modules do not depend on `quic_core/stream_id`, which the core
//// package declares internal. The transport exposes direction-specific open
//// operations, so its private `Direction` type no longer crosses this layer.
////
